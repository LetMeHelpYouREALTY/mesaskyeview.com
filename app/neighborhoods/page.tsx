          ...
          {isMesa && (
            <section className="max-w-6xl mx-auto mb-10">
              <Link
                ...
                className="block rounded-xl border-2 border-blue-200 bg-blue-50 p-6 hover:border-blue-400 transition-colors"
              >
                <p className="text-sm font-semibold text-blue-800 mb-1">Featured community</p>
                <h2 className="text-2xl font-bold text-slate-900 mb-2">{c.name}</h2>
                <p className="text-slate-600">
                  {c.masterPlan} · ZIP {c.zip} · {c.homeType} homes {c.sqftRange} sq ft — buyer &
                  seller guides, amenities, floor plans, and new construction.
                </p>
              </Link>
            </section>
          )}
